...
public class GetNewest {
	public static void inspectUser(TextChannel ch, String name, String poster) throws IOException {
		...
		try {
			...
			String[] infos = {j2.get("user").toString(), "https://pr0gramm.com/new/" + j2.get("id"), "Neuster Hochlad von " + j2.get("user").toString(),formatDate(j2.get("created").toString()),cat,"Kategorie: "+cat+ " | Blussi: " + benis[0] + ", Minus: " + benis[1], poster};
